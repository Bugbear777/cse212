...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: After one complete round, the next call to GetNextPerson skips the first and second people in the queue and passes straight to Sue.
    ...
    // Defect(s) Found: During the initial 5 turns (before George is added), the circular order is incorrect.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The queue does not maintain correct FIFO circular order.
    ...
    // Defect(s) Found: People with infinite turns (0 or less) are not re-enqueued.
